    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.checkbox = function (o) {
        ...
        return r.each(function () {
            var r, m, g = e.extend(!0, {}, e.fn.checkbox.settings, o), p = g.className, h = g.namespace, v = g.selector,
                ...
                k = e(this).children(v.input), S = k[0], T = !1, A = !1, R = C.data(x), E = this;
            m = {
                initialize: function () {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdown = function (o) {
        ...
        return r.each(function (p) {
            var h, v, b, y, x, C, w, k,
                ...
                T = S.className, A = S.message, R = S.fields, E = S.keys, P = S.metadata, F = S.namespace, O = S.regExp,
                        ...
                        keydown: function (e) {
                            ...
                            if (n) {
                                var i = I.find(D.label), o = i.filter("." + T.active),
                                    a = (o.data(P.value), i.index(o)), r = i.length, s = o.length > 0, l = o.length > 1,
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.modal = function (o) {
        ...
        return r.each(function () {
            var r, v, b, y, x, C, w, k, S,
                ...
                A = T.selector, R = T.className, E = T.namespace, P = T.error, F = "." + E, O = "module-" + E,
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.popup = function (o) {
        ...
        return r.each(function () {
            var r, v, b, y, x, C,
                ...
                k = w.selector, S = w.className, T = w.error, A = w.metadata, R = w.namespace, E = "." + w.namespace,
                P = "module-" + R, F = e(this), O = e(w.context), D = e(w.scrollContext), q = e(w.boundary),
                j = w.target ? e(w.target) : F, z = 0, M = !1, I = !1, L = this, N = F.data(P);
            C = {
                initialize: function () {
        ...
        e.fn.search = function (o) {
            ...
            return e(this).each(function () {
                var m,
                    ...
                    A = S.find(y.searchButton), R = S.find(y.results), E = S.find(y.result), P = S.find(y.category),
                ...
                m = {
                    initialize: function () {
                        ...
                        var t, n = S.find(y.result), i = S.find(y.category), o = n.filter("." + p.active),
                            a = n.index(o), r = n.length, s = o.length > 0, l = e.which,
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.tab = function (o) {
        ...
        return r.each(function () {
            var g, p, h, v, b, y,
                ...
                A = "module-" + x.namespace, R = e(this), E = {}, P = !0, F = 0, O = this, D = R.data(A);
            b = {
                initialize: function () {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.visibility = function (o) {
        ...
        return r.each(function () {
            var r, p, h, v,
                ...
                A = e(this), R = e(b.context), E = (A.selector || "", A.data(S)),
